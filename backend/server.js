...
app.route("/api/:table/programs").get(get_all_programs).post(create_program);

app
  .route("/api/:table/programs/:id")
  .get(get_program)
  .put(update_program)
...
app.route("/api/:table/pkgs").get(get_all_pkgs).post(create_pkg);
...
app.route("/api/:table/rules").get(get_all_rules).post(create_rule);

app
  .route("/api/:table/rules/:id")
  .get(get_rule)
  .put(update_rule)
  .delete(delete_rule);
